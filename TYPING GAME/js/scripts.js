...
//random numbers
const words =['sad', 'happy' ,'angry','rainbow', 'computer', 'science', 'program',
'python', 'maths', 'player', 'condition','html' , 'javascript' , 'hall' ,
'reverse', 'water', 'board','sandle' , 'clue', 'dope' ,' cam'];
